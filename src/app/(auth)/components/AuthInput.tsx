    ...
    <div className="w-full">
      ...
      <div className="relative">
        <input
          ...
          } text-[#FFF3CC80] placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#939391] focus:border-transparent transition-all text-[14px] sm:text-base ${className}`}
          {...props}
        />
        {showPasswordToggle && (
          <button
